...
function App() {
  ...
  const handleBackupFileChange = useCallback(event => {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "hidden text-xs text-emerald-600/80 sm:block sm:text-sm dark:text-emerald-300/80"
...
function TopNav({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "flex flex-wrap gap-2 sm:flex-nowrap sm:items-center"
  }, /*#__PURE__*/React.createElement("button", {
...
function BackupControls({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: onImport,
    type: "button"
  }, "Import JSON")), /*#__PURE__*/React.createElement("p", {
    className: "text-xs text-zinc-500"
